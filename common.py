...
from config import ct_phase_correction, ct0_channel, ct1_channel, ct2_channel, ct3_channel, ct4_channel, board_voltage_channel, v_sensor_channel, vbatt_sensor_channel, logger
import spidev
import subprocess
import docker
import sys
...
def collect_data(numSamples):
    ...
    for _ in range(numSamples):
        ...
        vbatt = readadc(vbatt_sensor_channel)
        ct0_data.append(ct0)
        ct1_data.append(ct1)
        ct2_data.append(ct2)
        ct3_data.append(ct3)
